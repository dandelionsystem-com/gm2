...
namespace System.gm
{
    public class FlexyPager
    {
        ...
        private FirstLastDisplay _firstLastDisplayStyle = FirstLastDisplay.ActualPageNumber;
        ...
        public FirstLastDisplay FirstLastDisplayStyle { get { return _firstLastDisplayStyle; } set { _firstLastDisplayStyle = value; } }
        ...
        private void BuildSlots()
        {
            ...
            if (TotalPages > TotalSlots && 
                slots[0] != 1 &&
                FirstLastDisplayStyle != FirstLastDisplay.None)
            {
                sb.Append(tab4);
                sb.Append("<td class=\"");
                ...
                if (FirstLastDisplayStyle == FirstLastDisplay.ActualPageNumber)
                    sb.Append("1");
                else if (FirstLastDisplayStyle == FirstLastDisplay.UserDefineText)
            ...
            if (TotalPages > TotalSlots &&
                slots[slots.Count-1] != TotalPages &&
                FirstLastDisplayStyle != FirstLastDisplay.None)
            {
                sb.Append(tab4);
                sb.Append("<td class=\"");
